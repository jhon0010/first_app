  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Review("assets/images/person.jpg", "Fernando Casas", "2 review 4 photos", "Corte muy bueno, recomendable."),
        Review("assets/images/person.jpg", "Gorge Garcia", "3 review 6 photos", "Corte muy bueno, recomendable."),
        Review("assets/images/person.jpg", "Juan Córdova", "5 review 3 photo", "Corte muy bueno, recomendable.")
      ],
    );
  }
